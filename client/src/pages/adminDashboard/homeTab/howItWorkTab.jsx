  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">How It Works Manager</h1>
          <p className="text-gray-600">Manage your tutorial videos and images</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-md p-4 border-l-4 border-purple-500">
            ...
            <p className="text-2xl font-bold text-gray-900">
              {list.filter(item => item.mediaType === "video").length}
            </p>
          </div>
          <div className="bg-white rounded-xl shadow-md p-4 border-l-4 border-orange-500">
            <p className="text-sm text-gray-600">Images</p>
            <p className="text-2xl font-bold text-gray-900">
              {list.filter(item => item.mediaType === "image").length}
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
            <h2 className="text-xl font-semibold text-white">Create New Tutorial</h2>
            <p className="text-blue-100 text-sm mt-1">Add video or image tutorial content</p>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-semibold text-gray-900">All Tutorials</h2>
          ...
          {list.length === 0 && (
            <div className="bg-white rounded-xl shadow-md p-12 text-center">
              ...
              <p className="mt-2 text-gray-500">Create your first tutorial by uploading a video or image</p>
            </div>
          )}
        </div>
          ...
          <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50 p-4">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md transform transition-all">
              <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 rounded-t-2xl">
                ...
                <p className="text-blue-100 text-sm">Update tutorial title</p>
              </div>
