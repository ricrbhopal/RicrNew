...
const MentorsPage = () => {
  return (
    <section className="min-h-screen bg-[#f5f5f7] py-12 md:py-16 px-4 md:px-10 mt-10 w-[90%] mx-auto  rounded-2xl">

      {/* 🔥 Heading */}
      <div className="max-w-6xl mx-auto mb-10 md:mb-14">
        <h2 className="text-2xl sm:text-3xl md:text-5xl font-semibold text-black mb-3 md:mb-4 leading-tight">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="relative w-full rounded-2xl overflow-hidden">
          ...
          <img
            src={Image}
            alt="Mentors"
            className="w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[550px] object-cover rounded-2xl"
          />

          {/* OPTIONAL OVERLAY (light gradient like premium UI) */}
