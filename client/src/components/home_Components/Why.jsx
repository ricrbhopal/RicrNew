    ...
    <section className="py-14 md:py-20 bg-[#f5f5f7] px-4 md:px-10 w-[90%] mx-auto rounded-2xl mt-10">
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 md:gap-16 items-center">
        ...
        <div>
          ...
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-semibold text-black mb-6 leading-tight">
            Why do students choose RICR?
          </h2>
        ...
        <div className="relative">
          <div className="w-full h-[250px] sm:h-[300px] md:h-[350px] rounded-2xl bg-black flex items-center justify-center text-white text-lg font-medium">
            RICR
          </div>

          {/* subtle glow / card effect */}
